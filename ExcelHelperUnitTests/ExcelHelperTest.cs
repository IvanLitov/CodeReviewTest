                    ...
                    if (worksheetPart != null)
                    {
                        ...
                        foreach (var row in rows)                                   // DocumentFormat.OpenXml.Spreadsheet.Row
                        {
                            ...
                            foreach (var cell in row.Descendants<Cell>())
                            {
                                ...
                                {
                                    dataTable.Rows[dataTable.Rows.Count - 1][0] = ExcelHelper_Accessor.GetCellValue(spreadsheetDocument, cell, 0u);
                                ...
                                var numberFormatId = ExcelHelper_Accessor.GetNumberFormatIdFromCellStyleIndex(cellFormats, cell);
                                ...
                                dataTable.Rows[dataTable.Rows.Count - 1][0] = ExcelHelper_Accessor.GetCellValue(spreadsheetDocument, cell, numberFormatId, formatCode);
